...
const tableData = [
  {
    name: "Antwon Johnson",
    jobType: "Exterior Wash",
    dateTime: "Nov 22, 2025 • 10:00 AM",
  },
  {
    name: "Mike Henry",
    jobType: "Interior Clean",
...
const MetricCard = ({
  ...
  metric: { title: string; value: string; icon: JSX.Element };
  bgColor: string;
}) => (
  <Box
    sx={{ backgroundColor: bgColor, borderRadius: "12px", p: { xs: 2, sm: 3 } }}
  >
    <Box
      sx={{
        width: "32px",
    ...
    <Typography
      sx={{ fontSize: "13px", fontWeight: 700, color: "#111827", mb: 1 }}
    >
      {metric.title}
    </Typography>
    <Typography
      ...
      <Box
        sx={{
          ...
          "&::before": {
            ...
            bottom: "-20px",
            background:
              "linear-gradient(180deg, rgba(81, 146, 251, 0.6) 0%, rgba(59, 130, 246, 0) 100%)",
            filter: "blur(50px)",
            zIndex: 0,
            borderRadius: "32px",
            opacity: 0.8,
          ...
          >
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                ...
                <Typography
                  sx={{ fontSize: "13px", color: "#D1D5DB", mx: 0.5 }}
                >
                  /
                </Typography>
                <Typography
                  sx={{ fontSize: "13px", fontWeight: 600, color: "#4B5563" }}
                >
                  Default
                </Typography>
              </Box>
              ...
              >
                ...
                <Box sx={{ textAlign: { xs: "center", sm: "left" } }}>
                  ...
                  >
                    ...
                    >
                      https://ravwork.link/martiecarspa
                    </Typography>
                    <Box
                      sx={{
                        display: "flex",
                    ...
                    >
                      ...
                      >
                        <HandHint
                          show={showHint}
                          direction="down"
                          sx={{ left: "0px", top: "15px", width: "35px" }}
                        />
                        <ReplyIcon
                          sx={{
                            fontSize: "14px",
            ...
            >
              {metricsTop.map((m, i) => (
                <MetricCard key={i} metric={m} bgColor="#E0F2FE" />
              ))}
            </Box>
            <Box
              sx={{
            ...
            >
              {metricsBottom.map((m, i) => (
                <MetricCard key={i} metric={m} bgColor="#F3F4F6" />
              ))}
            </Box>
                  ...
                  {[1, 2, 3, "...", 8, 9, 10].map((page, i) => (
                    <Box
                      ...
                      sx={{
                        width: "28px",
                        height: "28px",
                        backgroundColor: page === 1 ? "#F9FAFB" : "transparent",
                        color: page === 1 ? "#111827" : "#6B7280",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        borderRadius: "4px",
