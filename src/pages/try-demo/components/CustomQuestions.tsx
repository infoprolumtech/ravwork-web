...
export default function CustomQuestions({
  onBack,
  onNext,
}: CustomQuestionsProps): JSX.Element {
    ...
    >
      ...
      <GlowingCard>
        ...
        <Box sx={{ mb: { xs: 2, sm: 4 } }}>
          ...
          <Typography
            sx={{ color: "#9CA3AF", fontSize: "13px", fontWeight: 500 }}
          >
            Create Questions that will be asked to all clients during service
            booking
          </Typography>
        </Box>
        ...
        >
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                <TextField
                  ...
                  sx={{
                    ...textFieldSxGray,
                    "& .MuiOutlinedInput-root": {
                      ...textFieldSxGray["& .MuiOutlinedInput-root"],
                      py: 1,
                    },
                  }}
                />
          ...
          <Box sx={{ display: "flex", mt: 1 }}>
            <Button
              ...
              startIcon={
                <AddIcon
                  sx={{ fontSize: "16px !important", color: "#1E3A8A" }}
                />
              }
            >
              Add Questions
        ...
        >
          ...
          <Box sx={{ position: "relative" }}>
            <HandHint
              show={showHint}
              direction="down"
              sx={{ left: "50%", transform: "translateX(-50%)", top: "5px" }}
            />
            <PulseCTAButton
              onClick={onNext}
