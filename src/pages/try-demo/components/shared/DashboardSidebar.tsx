...
export default function DashboardSidebar({
  ...
  const footerLinks = (
    <Box
      sx={{ px: 4, mt: 4, display: "flex", flexDirection: "column", gap: 1 }}
    >
      <Typography
        sx={{
          fontSize: "12px",
      ...
      {showFooterExtras && (
        <>
          ...
          <Typography
            sx={{ fontSize: "10px", color: "#D1D5DB", mt: 3, lineHeight: 1.4 }}
          >
            Ravwork Inc. © 2023 All Right
            <br />
            Reserved
          </Typography>
        </>
    ...
    <>
      ...
      >
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
          ...
          <Typography
            sx={{ fontWeight: 600, fontSize: "16px", color: "#4B5563" }}
          >
            {activeItem}
          </Typography>
        </Box>
        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 0.75 }}>
          ...
          />
          <Typography
            sx={{ fontWeight: 700, fontSize: "15px", color: "#111827" }}
          >
            Ravwork
          </Typography>
        </Box>
